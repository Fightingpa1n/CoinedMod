package net.fightingpainter.mc.coined.gui.screens;

import com.mojang.blaze3d.systems.RenderSystem;

import net.fightingpainter.mc.coined.gui.menus.ShopMenu;
...
public class ShopScreen extends AbstractContainerScreen<ShopMenu> {
    ...
    private static final ResourceLocation BACKGROUND = ResourceLocation.fromNamespaceAndPath(Coined.MOD_ID, "textures/gui/shop/shop.png");
